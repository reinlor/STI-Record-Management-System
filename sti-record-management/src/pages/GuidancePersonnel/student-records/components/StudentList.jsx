    ...
    const handleDownload = () => {
        ...
        const excelData = data.map(s => {
            ...
            return {
                ...
                "Email": s.studentProfile?.email,
                "Contact No": s.studentProfile?.contactNo,
                // Basic
                "Full Name": info.basic?.fullName,
                "Student Number": info.basic?.studentNumber,
                "Basic Email": info.basic?.email,
                "Basic Contact No": info.basic?.contactNo,
                "Basic Academic Level": info.basic?.academicLevel,
                "Basic Program & Section": info.basic?.programAndSection,
                "Basic Birth Date": info.basic?.birthDate,
                "Basic Gender": info.basic?.gender,
                "Basic Address": info.basic?.address,
                "Basic Health Condition": info.basic?.healthCondition,
                "Basic Emergency Contact": info.basic?.emergencyContact,
                // Personal
                "Personal Religion": info.personal?.religion,
                "Personal Civil Status": info.personal?.civilStatus,
                "Personal Nationality": info.personal?.nationality,
                "Personal Place of Birth": info.personal?.placeOfBirth,
                // Contact
                "Contact Mobile No": info.contact?.mobileNo,
                "Contact Telephone No": info.contact?.telephoneNo,
                "Contact Address": info.contact?.address,
                // Family
                ...
                "Guardian Contact": info.family?.guardianContact,
                // Educational
                "Elementary School": info.educational?.elementarySchool,
                "Elementary Year Graduated": info.educational?.elementaryYearGraduated,
                "Junior High School": info.educational?.juniorHighSchool,
                "Junior High Year Graduated": info.educational?.juniorHighYearGraduated,
                "Senior High School": info.educational?.seniorHighSchool,
                "Senior High Year Graduated": info.educational?.seniorHighYearGraduated,
                "College School": info.educational?.collegeSchool,
                "College Year Graduated": info.educational?.collegeYearGraduated,
                // Work
                "Work Company": info.work?.company,
                "Work Position": info.work?.position,
                "Work Years": info.work?.years,
                // Interests
                "Interests": info.interests?.interests,
                // Health
                "Health Condition": info.health?.condition,
                "Health Notes": info.health?.notes,
                // Life
                "Life Goals": info.life?.goals,
                "Life Notes": info.life?.notes,
            };
        });
