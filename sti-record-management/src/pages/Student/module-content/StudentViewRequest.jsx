        ...
        <div className="overflow-x-auto rounded-xl border border-gray-200 shadow-sm">
          <table className="min-w-full text-left table-auto">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="px-6 py-3 text-sm font-semibold text-gray-600 tracking-wide">
                  Slip Type
                </th>
                <th className="px-6 py-3 text-sm font-semibold text-gray-600 tracking-wide">
                  Date Submitted
            ...
            <tbody>
              {filtered.length > 0 ? (
                filtered.map((row, idx) => (
                  <tr
                    key={idx}
                    className="bg-white border-b hover:bg-gray-50 transition-colors duration-150 ease-in-out"
                  >
